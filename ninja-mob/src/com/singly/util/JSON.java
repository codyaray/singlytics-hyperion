...
public class JSON {
  ...
  public static enum TYPE {JSON_OBJECT, JSON_ARRAY, JUNK}
  ...
  public static TYPE determinType(String content) {
    String trimmed = content.trim();
  ...
  /**
   * It carefully parse json. That is, if json is JsonArray parse it accordingly.
   *
   * @param json
   * @return The parsed JSONObject or null if the string cannot be parsed.
   */
  public static JSONObject parse(String json) {
    switch (determinType(json)) {
      case JUNK:
        return null;
      case JSON_OBJECT:
        return parseJsonObject(json);
      case JSON_ARRAY:
        return parseJsonObject(wrap(json));
    }
    return null;
  }
